...
Qwik also support computed value.
Computed value means when you want to have some value calculated based on other value (the other value mostly from the props).
